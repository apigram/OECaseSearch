    ...
    */
    ...
    public function query($searchProvider)
    {
        ...
        if ($searchProvider->getProviderID()  === 'mysql')
        {
            ...
            return "SELECT p.id FROM patient p JOIN secondary_diagnosis sd ON sd.patient_id = p.id JOIN disorder d ON d.id = sd.disorder_id WHERE d.term $op :p_d_value_$this->id";
        }
        else
        {
